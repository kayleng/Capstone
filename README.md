...
> Not yet. Still in the progress of data cleaning.
Might have to resize and crop images (aspect ratio)
Need more work on image preprocessing (applying filters?)
Convert to array for modelling.
...
> Might require use of AWS.
Have not attempted on inputing image data into models.
...
> Yes there is a change of topic but data in hand.



6) What is your timeline for the next week and a half? What do you have to get done versus what would you like to get done?

> Complete preprocessing stage and move on to complete at least one round of modelling?
